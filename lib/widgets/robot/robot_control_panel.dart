        ...
        return Card(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                _ControlPanelHeader(userId: userId, robotProvider: robotProvider),
                ...
                _LocationStatus(robotProvider: robotProvider),
              ],
            ),
          ),
        );
...
class _ControlPanelHeader extends StatelessWidget {
  ...
  const _ControlPanelHeader({required this.userId, required this.robotProvider});
      ...
      child: AnimatedBuilder(
          ...
          builder: (context, child) {
            return SliderTheme(
              ...
              child: Slider(
                value: robotProvider.sliderValue,
                min: 0.0,
                max: 1.0,
...
class _LocationStatus extends StatelessWidget {
  ...
  const _LocationStatus({required this.robotProvider});
